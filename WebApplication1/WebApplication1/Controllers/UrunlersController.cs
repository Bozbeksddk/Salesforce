...
namespace WebApplication1.Controllers
{
    public class UrunlersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UrunID,UrunAdi,RefKategoriID,Adet,Fiyat")] Urunler urunler)
        {
            ...
            ViewBag.RefKategoriID = new SelectList(db.Kategoris, "KategoriID", "KategoriAdi", urunler.RefKategoriID);
            return View(urunler);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UrunID,UrunAdi,RefKategoriID,Adet,Fiyat")] Urunler urunler)
        {
            if (ModelState.IsValid)
            {
